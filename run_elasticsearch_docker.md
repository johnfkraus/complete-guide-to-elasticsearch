...
PASSWORD apm_system = BJJMkfElhOLr7lQ4SCwK

Changed password for user kibana_system
PASSWORD kibana_system = eUjnhN968EvErnpYZp8U

Changed password for user kibana
PASSWORD kibana = eUjnhN968EvErnpYZp8U

Changed password for user logstash_system
PASSWORD logstash_system = yKmCNSsCHjuDDJOOiBHv

Changed password for user beats_system
PASSWORD beats_system = xZujEsuecUbIiLEDJ0xg

Changed password for user remote_monitoring_user
PASSWORD remote_monitoring_user = mQvSUOMDpt9jWZ1D8Jd2

Changed password for user elastic
PASSWORD elastic = wCb3HLmy9lXZyfBajxIc
...
docker run -d --name kibana \
  ...
  -e "ELASTICSEARCH_PASSWORD=eUjnhN968EvErnpYZp8U" \
