...
filter - query clauses are required to match and will not contribute to relevance scores.  Filter query clauses may be cached and thereby improve performance.

must_not - Query clauses must NOT match and don't affect relevance scoring.  Cacheable.
